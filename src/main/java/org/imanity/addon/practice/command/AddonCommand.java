...
public class AddonCommand implements CommandExecutor {
    ...
    public AddonCommand(ImanityPracticeAddon plugin) {
        this.plugin = plugin;
    }

    private final String PREFIX = CC.translate("&a[ImanityPracticeAddon]");
    private final String PREFIX_ERROR = CC.translate("&c[ImanityPracticeAddon]");

    private final Consumer<CommandSender> HELP_MESSAGE = (sender -> {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("reload")) {
            ...
            ImanityPracticeAddon.getInstance().save();
            return true;
